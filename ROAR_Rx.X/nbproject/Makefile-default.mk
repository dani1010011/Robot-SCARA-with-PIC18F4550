...
SOURCEFILES_QUOTED_IF_SPACED=18F4550.c lcd_lib.c SPI.c rx_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/18F4550.p1 ${OBJECTDIR}/lcd_lib.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/rx_main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/18F4550.p1.d ${OBJECTDIR}/lcd_lib.p1.d ${OBJECTDIR}/SPI.p1.d ${OBJECTDIR}/rx_main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/18F4550.p1 ${OBJECTDIR}/lcd_lib.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/rx_main.p1

# Source Files
SOURCEFILES=18F4550.c lcd_lib.c SPI.c rx_main.c
...
${OBJECTDIR}/rx_main.p1: rx_main.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/rx_main.p1 rx_main.c 
